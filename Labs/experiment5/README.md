...
docker inspect web1 | grep -A 5 Mounts 2. Named Volumes
...
docker volume inspect mydata 3. Bind Mounts (Host Directory)
...
docker exec web1 curl http://web2 2. Host Network
...
curl http://localhost 3. None Network
